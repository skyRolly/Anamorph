...
## Project status
- **Version 0.8.9** (pre-1.0). Active development on a feature-branch → PR → `main` workflow.
- Validation gate: **25 DSP self-tests** + **pluginval strictness 10** (headless Linux, blocking).
