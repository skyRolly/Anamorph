...
DELIBERATE_REAIMS = {
    ...
    ("docs/FUTURE_RISKS.md",
     ...
     "src/PluginProcessor.cpp:1498-1569"): "setStateInformation",
    ("docs/FUTURE_RISKS.md",
     "src/PluginProcessor.cpp:1001",
     "src/PluginProcessor.cpp:1498"): "setStateInformation",
    ("docs/FUTURE_RISKS.md",
     "src/PluginProcessor.cpp:1065",
     "src/PluginProcessor.cpp:1135"): "abActive",
    ...
    ("docs/architecture/PARAMETER_REGISTRY.md",
     ...
     "src/PluginProcessor.cpp:1327-1330"): "resolveLegacy",
