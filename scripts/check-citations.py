...
DELIBERATE_REAIMS = {
    ...
    ("docs/FUTURE_RISKS.md",
     ...
     "src/PluginProcessor.cpp:1239-1500"): "setStateInformation",
    ("docs/FUTURE_RISKS.md",
     "src/PluginProcessor.cpp:1001",
     "src/PluginProcessor.cpp:1445"): "setStateInformation",
    ("docs/FUTURE_RISKS.md",
     "src/PluginProcessor.cpp:1065",
     "src/PluginProcessor.cpp:1090"): "abActive",
    ("docs/architecture/API_REFERENCE.md",
     "src/InternalState.h:165-280",
     "src/InternalState.h:165-361"): "oversampleValue",
    ...
    ("docs/architecture/PARAMETER_REGISTRY.md",
     ...
     "src/PluginProcessor.cpp:1276-1279"): "resolveLegacy",
    ("docs/architecture/SERIALIZATION_REGISTRY.md",
     "src/PluginProcessor.cpp:1037-1040",
     "src/PluginProcessor.cpp:1276-1279"): "resolveLegacy",
    ("docs/architecture/SERIALIZATION_REGISTRY.md",
     "src/InternalState.h:197-286",
     "src/InternalState.h:198-359"): "resolveRestore",
    ("docs/architecture/SERIALIZATION_REGISTRY.md",
     "src/PluginProcessor.cpp:968-969",
     "src/PluginProcessor.cpp:1147-1155"): "writeSelection",
    ("docs/architecture/SERIALIZATION_REGISTRY.md",
     "src/InternalState.h:235-286",
     "src/InternalState.h:255-309"): "comboId",
    ("docs/architecture/SERIALIZATION_REGISTRY.md",
     "src/PluginProcessor.cpp:874-904",
     "src/PluginProcessor.cpp:1375-1399"): "the whole block above is skipped",
    ("docs/architecture/SERIALIZATION_REGISTRY.md",
     "src/PluginProcessor.cpp:1066-1153",
     "src/PluginProcessor.cpp:1300-1373"): "adoptIfAnamorph",
    ("docs/architecture/SERIALIZATION_REGISTRY.md",
     "src/PluginProcessor.cpp:1155-1169",
     "src/PluginProcessor.cpp:1401-1423"): "hasTagName",
    ("docs/architecture/STATE_SERIALIZATION.md",
     "src/PluginProcessor.cpp:964-994",
     "src/PluginProcessor.cpp:1189-1234"): "getStateInformation",
    ...
    ("docs/policies/THREADING_POLICY.md",
     ...
     "src/InternalState.h:175, 387-410"): "engineConfig",
