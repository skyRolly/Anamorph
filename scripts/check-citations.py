...
DELIBERATE_REAIMS = {
    ...
    ("EULA.md",
     ...
     "src/PluginEditor.h:1350"): "aboutLink",
    ("PRIVACY.md",
     "src/PluginEditor.h:1021",
     "src/PluginEditor.h:1350"): "aboutLink",
    ("PRIVACY.md",
     "src/PluginEditor.cpp:2221",
     "src/PluginEditor.cpp:2291"): "createDirectory",
    ("TRADEMARKS.md",
     "src/PluginEditor.h:1021",
     "src/PluginEditor.h:1350"): "aboutLink",
    ("docs/DOCUMENTATION_COVERAGE.md",
     "src/gui/LookAndFeel.cpp:1005-1014",
     "src/gui/LookAndFeel.cpp:1211-1220"): "layoutTooltip",
    ("docs/DOCUMENTATION_COVERAGE.md",
    ...
    ("docs/KNOWN_ISSUES.md",
     ...
     "src/gui/LookAndFeel.cpp:780-783"): "getPopupMenuFont",
    ("docs/KNOWN_ISSUES.md",
     "src/PluginEditor.cpp:2319-2327",
     "src/PluginEditor.cpp:2389-2397"): "focusSaveNameField",
    ("docs/KNOWN_ISSUES.md",
     "src/PluginEditor.cpp:2275",
     "src/PluginEditor.cpp:2345"): "focusSaveNameField",
    ("docs/KNOWN_ISSUES.md",
     "src/PluginEditor.cpp:2257-2327",
     "src/PluginEditor.cpp:2327-2397"): "focusSaveNameField",
    ("docs/POSTMORTEMS.md",
     "src/PluginEditor.cpp:1865-1869",
     "src/PluginEditor.cpp:1882-1886"): "cursorOverPopup",
    ("docs/POSTMORTEMS.md",
     "src/PluginEditor.cpp:1577-1580",
     "src/PluginEditor.cpp:1590-1593"): "cursorOverPopup",
    ("docs/architecture/THREAD_MODEL.md",
     "src/PluginEditor.cpp:759",
     "src/PluginEditor.cpp:775"): "startTimerHz",
    ("docs/architecture/THREAD_MODEL.md",
     "src/PluginEditor.cpp:1981-1982",
     "src/PluginEditor.cpp:1998-1999"): "triggerRepaint",
    ("docs/architecture/THREAD_MODEL.md",
     "src/PluginEditor.cpp:762-768",
     "src/PluginEditor.cpp:778-784"): "VBlankAttachment",
    ("docs/architecture/THREAD_MODEL.md",
     "src/PluginEditor.cpp:759, 1497-1677",
     "src/PluginEditor.cpp:775, 1510-1690"): "abortAbandonedDragGestures",
    ("docs/architecture/THREAD_MODEL.md",
     "src/PluginEditor.cpp:776-778",
     "src/PluginEditor.cpp:792-794"): "meterVBlank",
    ("docs/procedures/CI_CD.md",
     "src/gui/LookAndFeel.cpp:328",
     "src/gui/LookAndFeel.cpp:482"): "Rectangle",
    ("tests/state_tests.cpp",
     "src/PluginEditor.cpp:2567",
     "src/PluginEditor.cpp:2637"): "multiBar",
    ...
    ("docs/DOCUMENTATION_COVERAGE.md",
     ...
     "src/PluginEditor.cpp:2486-2511"): "oversampleBox",
    ("docs/DOCUMENTATION_COVERAGE.md",
    ...
    ("docs/FUTURE_RISKS.md",
     ...
     "src/PresetManager.cpp:1121"): "copyState",
    ("docs/architecture/design-decisions/ADR-0008-custom-per-ab-undo.md",
