...
DELIBERATE_REAIMS = {
    ...
    ("docs/FUTURE_RISKS.md",
     ...
     "src/PluginProcessor.cpp:1226-1485"): "setStateInformation",
    ("docs/FUTURE_RISKS.md",
     "src/PluginProcessor.cpp:1001",
     "src/PluginProcessor.cpp:1432"): "setStateInformation",
    ("docs/FUTURE_RISKS.md",
     "src/PluginProcessor.cpp:1065",
     "src/PluginProcessor.cpp:1081"): "abActive",
    ("docs/architecture/API_REFERENCE.md",
     "src/InternalState.h:165-280",
     "src/InternalState.h:165-337"): "oversampleValue",
    ("docs/architecture/PARAMETER_REGISTRY.md",
     "src/InternalState.h:197-286",
     "src/InternalState.h:252-306"): "resolveLegacy",
    ("docs/architecture/PARAMETER_REGISTRY.md",
     "src/PluginProcessor.cpp:677-680",
     "src/PluginProcessor.cpp:1263-1266"): "resolveLegacy",
    ("docs/architecture/SERIALIZATION_REGISTRY.md",
     "src/PluginProcessor.cpp:1037-1040",
     "src/PluginProcessor.cpp:1263-1266"): "resolveLegacy",
    ("docs/architecture/SERIALIZATION_REGISTRY.md",
     "src/InternalState.h:197-286",
     "src/InternalState.h:196-335"): "resolveRestore",
    ("docs/architecture/SERIALIZATION_REGISTRY.md",
     "src/PluginProcessor.cpp:968-969",
     "src/PluginProcessor.cpp:1138-1146"): "writeSelection",
    ("docs/architecture/SERIALIZATION_REGISTRY.md",
     "src/InternalState.h:235-286",
     "src/InternalState.h:252-306"): "comboId",
    ("docs/architecture/SERIALIZATION_REGISTRY.md",
     "src/PluginProcessor.cpp:874-904",
     "src/PluginProcessor.cpp:1362-1386"): "the whole block above is skipped",
    ("docs/architecture/SERIALIZATION_REGISTRY.md",
     "src/PluginProcessor.cpp:1066-1153",
     "src/PluginProcessor.cpp:1287-1360"): "adoptIfAnamorph",
    ("docs/architecture/SERIALIZATION_REGISTRY.md",
     "src/PluginProcessor.cpp:1155-1169",
     "src/PluginProcessor.cpp:1388-1410"): "hasTagName",
    ("docs/architecture/STATE_SERIALIZATION.md",
     "src/PluginProcessor.cpp:964-994",
     "src/PluginProcessor.cpp:1180-1221"): "getStateInformation",
    ("docs/architecture/design-decisions/ADR-0024-preset-identity.md",
     "src/PluginProcessor.cpp:63-74",
     "src/PluginProcessor.cpp:68-90"): "onSaved",
    ...
    ("docs/policies/THREADING_POLICY.md",
     ...
     "src/InternalState.h:173, 340-352"): "osAtomic",
}
