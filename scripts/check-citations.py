...
DELIBERATE_REAIMS = {
    ...
    ("docs/FUTURE_RISKS.md",
     ...
     "src/PluginProcessor.cpp:1676-1747"): "setStateInformation",
    ("docs/FUTURE_RISKS.md",
     "src/PluginProcessor.cpp:1001",
     "src/PluginProcessor.cpp:1676"): "setStateInformation",
    ("docs/FUTURE_RISKS.md",
     "src/PluginProcessor.cpp:1065",
     "src/PluginProcessor.cpp:1237"): "abActive",
    ("docs/architecture/API_REFERENCE.md",
     "src/InternalState.h:165-280",
     "src/InternalState.h:165-420"): "oversampleValue",
    ...
    ("docs/policies/THREADING_POLICY.md",
     ...
     "src/InternalState.h:175, 533-556"): "engineConfig",
