...
DELIBERATE_REAIMS = {
    ...
    ("docs/FUTURE_RISKS.md",
     ...
     "src/PluginProcessor.cpp:1519-1590"): "setStateInformation",
    ("docs/FUTURE_RISKS.md",
     "src/PluginProcessor.cpp:1001",
     "src/PluginProcessor.cpp:1519"): "setStateInformation",
    ("docs/FUTURE_RISKS.md",
     "src/PluginProcessor.cpp:1065",
     "src/PluginProcessor.cpp:1149"): "abActive",
    ("docs/architecture/API_REFERENCE.md",
     "src/InternalState.h:165-280",
     "src/InternalState.h:165-376"): "oversampleValue",
    ...
    ("docs/policies/THREADING_POLICY.md",
     ...
     "src/InternalState.h:175, 441-464"): "engineConfig",
