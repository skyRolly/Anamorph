...
| **A7-5E** — diff the universal binary's two slices | **ANSWERED by inference 2026-08-22: the slices already differ.** Confirmation by execution still open. One CI step, no new tooling, answers a question the product has never asked. |
