...
Evidence [Verified]:
- Source: src/PluginProcessor.cpp:251-319 (`processBlock`; `ScopedNoDenormals` at :119), src/dsp/AnamorphEngine.cpp:28-150 (prepare allocations) vs :660-1339 (alloc-free process)
