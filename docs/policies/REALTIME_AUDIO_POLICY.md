...
Evidence [Verified]:
- Source: src/PluginProcessor.cpp:238-306 (`processBlock`; `ScopedNoDenormals` at :119), src/dsp/AnamorphEngine.cpp:28-127 (prepare allocations) vs :660-1339 (alloc-free process)
