...
Evidence [Verified]:
- Source: src/PluginProcessor.cpp:261-329 (`processBlock`; `ScopedNoDenormals` at :119), src/dsp/AnamorphEngine.cpp:38-168 (prepare allocations) vs :660-1339 (alloc-free process)
