...
Evidence [Verified]:
- Source: src/PluginProcessor.cpp:215-283 (`processBlock`; `ScopedNoDenormals` at :119), src/dsp/AnamorphEngine.cpp:28-125 (prepare allocations) vs :660-1339 (alloc-free process)
