...
Evidence [Verified]:
- Source: src/PluginProcessor.cpp:325-393 (`processBlock`; `ScopedNoDenormals` at :119), src/dsp/AnamorphEngine.cpp:43-181 (prepare allocations) vs :660-1339 (alloc-free process)
