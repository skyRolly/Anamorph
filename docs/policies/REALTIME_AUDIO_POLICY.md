...
Evidence [Verified]:
- Source: src/PluginProcessor.cpp:384-452 (`processBlock`; `ScopedNoDenormals` at :119), src/dsp/AnamorphEngine.cpp:43-205 (prepare allocations) vs :660-1339 (alloc-free process)
