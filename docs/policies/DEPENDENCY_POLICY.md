...
|---|---|---|---|
| **JUCE** | **9.0.2**, pinned by **immutable commit SHA** `72782788ce18c2d4d760b28e0921d6ffc6431102` | CMake `FetchContent` (`GIT_SHALLOW`), overridable via `-DANAMORPH_JUCE_PATH` | CMakeLists.txt:70-72, 81-89 |
