...
Evidence [Verified]: src/PluginProcessor.cpp:1618-1689 (`decodeRestore` + `setStateInformation`: the AnamorphRoot read path, the pre-0.6.4 `readSlot` legacy-key fallback at :1334-1335, and the v0.2 else-branch at :1388); src/InternalState.h:255-309.
