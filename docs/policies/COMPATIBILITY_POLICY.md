...
Evidence [Verified]: src/PluginProcessor.cpp:645-796 (`setStateInformation`: the AnamorphRoot read path, the pre-0.6.4 `readSlot` legacy-key fallback at :743-744, and the v0.2 else-branch at :752); src/InternalState.h:100-122.
