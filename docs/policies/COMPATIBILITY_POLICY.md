...
Evidence [Verified]: src/PluginProcessor.cpp:901-1134 (`setStateInformation`: the AnamorphRoot read path, the pre-0.6.4 `readSlot` legacy-key fallback at :753-754, and the v0.2 else-branch at :762); src/InternalState.h:134-191.
