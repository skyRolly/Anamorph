...
- **Level 2/3 self-tests must pass** (the headless gate, `scripts/run-tests.sh`): the 47 DSP
  self-tests, the A/B state-restoration clamp guard, **and** the 28-test state-compatibility
