...
- **Evidence [Verified]:** src/dsp/AnamorphEngine.cpp:1274 (`mbStructuralChange` includes
...
>   corrected 2026-09-25; ADR-0007, Amendment of 2026-09-25, A/B provenance; Test 70, State test 134). So does a **new sample rate**, by
