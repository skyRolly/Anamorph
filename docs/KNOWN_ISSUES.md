...
- **Evidence [Verified]:** src/dsp/AnamorphEngine.cpp:917 (`mbStructuralChange` includes
...
- **Evidence [Verified]:** .github/workflows/build.yml:2234-2236 (`codesign --force --deep --sign -`,
