...
- **Evidence [Verified]:** src/dsp/AnamorphEngine.cpp:1132 (`mbStructuralChange` includes
...
> engage made shortly after a sound change lands on a value that is still converging. Both are F13(2), recorded under KI-030.
