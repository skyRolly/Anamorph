...
| **Test Status** | 23 DSP self-tests + pluginval strictness 10 (Linux gate) — **green on CI after the JUCE 8.0.14 bump** (`41acaa7`); no DSP-output change. `docs/procedures/TESTING.md`. |
