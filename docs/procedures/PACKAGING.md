...
| Field | Value | Source |
|---|---|---|
| Company | RollyTech | CMakeLists.txt:353 |
| Bundle ID | `com.rollytech.anamorph` | CMakeLists.txt:354 |
| Manufacturer code | `RTec` | CMakeLists.txt:355 — vendor-wide, shared by every RollyTech plug-in; was `Anmf` before 0.9.1 (ADR-0023) |
| Plugin code | `Anmr` | CMakeLists.txt:356 |
| Product name | Anamorph | CMakeLists.txt:358 |
| VST3 categories | Fx, Spatial, Stereo | CMakeLists.txt:365 |
