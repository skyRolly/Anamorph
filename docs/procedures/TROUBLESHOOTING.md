...
| Linker errors mixing JUCE modules | DSP compiled as a STATIC lib | The DSP core is an **INTERFACE** lib by design (CMakeLists.txt:326-337) — keep it INTERFACE; do not pre-compile JUCE modules into a static lib. |
