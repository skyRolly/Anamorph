...
| Wrong/old JUCE behaviour | Stale fetched JUCE | Confirm the pinned commit `7278278…` = JUCE 9.0.2 (CMakeLists.txt:70-72); a JUCE bump is a Build System change (ARCHITECTURE_REVIEW_GATE, ADR-0022 / ADR-0026 / ADR-0054). |
