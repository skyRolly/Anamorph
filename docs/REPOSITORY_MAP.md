...
| Path | Responsibility |
|---|---|
| `tests/dsp_tests.cpp` | 45 headless DSP acceptance tests + 1 A/B state-restoration clamp guard (`check(cond, "...")` harness; `main` runs all). |
