...
- `src/dsp/AnamorphEngine.cpp:700-769` (A(dry) production), `:726-759` (smoothstep Mix)

Evidence [Verified]:
- Source: src/dsp/MultibandWidth.cpp:154-168; src/dsp/AnamorphEngine.cpp:805-838
