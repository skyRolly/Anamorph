...
- `src/dsp/AnamorphEngine.cpp:862-933` (A(dry) production), `:726-759` (smoothstep Mix)

Evidence [Verified]:
- Source: src/dsp/MultibandWidth.cpp:154-168; src/dsp/AnamorphEngine.cpp:992-1045
