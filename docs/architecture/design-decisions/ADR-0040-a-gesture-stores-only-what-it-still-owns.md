...
only reads these parameters — `src/dsp/AnamorphEngine.cpp:1007` (`multiband.setCrossovers`) and
`src/dsp/AnamorphEngine.cpp:1014` (`soloMonitor.setCrossovers`). Every writer is therefore the imager
