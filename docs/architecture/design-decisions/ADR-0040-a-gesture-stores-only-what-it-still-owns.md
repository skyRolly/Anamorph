...
only reads these parameters — `src/dsp/AnamorphEngine.cpp:793` (`multiband.setCrossovers`) and
`src/dsp/AnamorphEngine.cpp:800` (`soloMonitor.setCrossovers`). Every writer is therefore the imager
