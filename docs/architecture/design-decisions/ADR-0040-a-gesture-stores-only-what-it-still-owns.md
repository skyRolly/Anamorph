...
only reads these parameters — `src/dsp/AnamorphEngine.cpp:1017` (`multiband.setCrossovers`) and
`src/dsp/AnamorphEngine.cpp:1024` (`soloMonitor.setCrossovers`). Every writer is therefore the imager
