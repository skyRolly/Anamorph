...
only reads these parameters — `src/dsp/AnamorphEngine.cpp:814` (`multiband.setCrossovers`) and
`src/dsp/AnamorphEngine.cpp:821` (`soloMonitor.setCrossovers`). Every writer is therefore the imager
