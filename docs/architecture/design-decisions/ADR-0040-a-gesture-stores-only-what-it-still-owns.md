...
only reads these parameters — `src/dsp/AnamorphEngine.cpp:872` (`multiband.setCrossovers`) and
`src/dsp/AnamorphEngine.cpp:879` (`soloMonitor.setCrossovers`). Every writer is therefore the imager
