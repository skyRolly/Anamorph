...
only reads these parameters — `src/dsp/AnamorphEngine.cpp:890` (`multiband.setCrossovers`) and
`src/dsp/AnamorphEngine.cpp:897` (`soloMonitor.setCrossovers`). Every writer is therefore the imager
