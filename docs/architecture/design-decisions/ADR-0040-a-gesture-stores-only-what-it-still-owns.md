...
only reads these parameters — `src/dsp/AnamorphEngine.cpp:892` (`multiband.setCrossovers`) and
`src/dsp/AnamorphEngine.cpp:899` (`soloMonitor.setCrossovers`). Every writer is therefore the imager
