...
only reads these parameters — `src/dsp/AnamorphEngine.cpp:817` (`multiband.setCrossovers`) and
`src/dsp/AnamorphEngine.cpp:824` (`soloMonitor.setCrossovers`). Every writer is therefore the imager
