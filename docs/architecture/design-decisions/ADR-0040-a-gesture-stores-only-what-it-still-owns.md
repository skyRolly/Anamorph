...
only reads these parameters — `src/dsp/AnamorphEngine.cpp:912` (`multiband.setCrossovers`) and
`src/dsp/AnamorphEngine.cpp:919` (`soloMonitor.setCrossovers`). Every writer is therefore the imager
