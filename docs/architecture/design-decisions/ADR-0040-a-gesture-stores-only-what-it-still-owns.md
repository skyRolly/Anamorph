...
only reads these parameters — `src/dsp/AnamorphEngine.cpp:899` (`multiband.setCrossovers`) and
`src/dsp/AnamorphEngine.cpp:906` (`soloMonitor.setCrossovers`). Every writer is therefore the imager
