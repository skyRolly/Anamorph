...
- `src/dsp/AnamorphEngine.cpp:1863-1913` (NaN/Inf self-heal)
- `src/dsp/LevelMeters.h:98-102, 167` (`sanitize`)

Evidence [Verified]:
- Source: src/dsp/MultibandWidth.cpp:55-71; src/dsp/AnamorphEngine.cpp:1863-1913; src/dsp/LevelMeters.h
