...
- `src/dsp/AnamorphEngine.cpp:1719-1769` (NaN/Inf self-heal)
- `src/dsp/LevelMeters.h:73-77,142` (`sanitize`)

Evidence [Verified]:
- Source: src/dsp/MultibandWidth.cpp:55-71; src/dsp/AnamorphEngine.cpp:1719-1769; src/dsp/LevelMeters.h
