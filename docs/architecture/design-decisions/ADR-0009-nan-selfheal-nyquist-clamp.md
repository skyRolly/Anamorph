...
- **Level Match — a node the guard did not reach.** `LoudnessMatch` publishes NaN from a non-finite
  ...
  (`src/dsp/AnamorphEngine.cpp:1841-1842`); every finite reading is unchanged. Test 65. The gain the
...
- `src/dsp/AnamorphEngine.cpp:1977-2027` (NaN/Inf self-heal)
- `src/dsp/LevelMeters.h:98-102, 167` (`sanitize`)

Evidence [Verified]:
- Source: src/dsp/MultibandWidth.cpp:55-71; src/dsp/AnamorphEngine.cpp:1977-2027; src/dsp/LevelMeters.h
