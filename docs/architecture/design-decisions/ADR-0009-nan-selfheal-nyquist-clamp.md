...
- **Level Match — a node the guard did not reach.** `LoudnessMatch` publishes NaN from a non-finite
  ...
  (`src/dsp/AnamorphEngine.cpp:1807-1808`); every finite reading is unchanged. Test 65. The gain the
...
- `src/dsp/AnamorphEngine.cpp:1943-1993` (NaN/Inf self-heal)
- `src/dsp/LevelMeters.h:98-102, 167` (`sanitize`)

Evidence [Verified]:
- Source: src/dsp/MultibandWidth.cpp:55-71; src/dsp/AnamorphEngine.cpp:1943-1993; src/dsp/LevelMeters.h
