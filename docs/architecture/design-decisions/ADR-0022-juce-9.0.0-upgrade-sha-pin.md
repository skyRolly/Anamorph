...
- `ANAMORPH_JUCE_TAG` → **`f8f8864172464b9adf9eba6101e1f784838d1597`** (the commit of upstream
  ...
  printed by the configure banner (`CMakeLists.txt:48-50, 59-67`). GitHub serves shallow
...
## Related code
- `CMakeLists.txt:48-50` (pin), `:47-55` (FetchContent); `scripts/setup-linux.sh` (EGL).

Evidence:
- Source [Verified]: CMakeLists.txt:48-50 (SHA pin; `ANAMORPH_JUCE_VERSION`).
