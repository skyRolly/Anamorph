...
## Related code
- `src/dsp/AnamorphEngine.cpp:245-272` (`discreteDiffers`, exclusions), `:480-562` (switch machine)
...
Evidence [Verified]:
- Source: src/dsp/AnamorphEngine.cpp:245-272, 1113-1324; src/dsp/SoloMonitor.cpp:59-109
