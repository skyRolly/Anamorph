...
## Related code
- `src/dsp/AnamorphEngine.cpp:306-333` (`discreteDiffers`, exclusions), `:480-562` (switch machine)
...
Evidence [Verified]:
- Source: src/dsp/AnamorphEngine.cpp:306-333, 1200-1411; src/dsp/SoloMonitor.cpp:59-109
