...
## Related code
- `src/dsp/AnamorphEngine.cpp:203-230` (`discreteDiffers`, exclusions), `:480-562` (switch machine)
...
Evidence [Verified]:
- Source: src/dsp/AnamorphEngine.cpp:203-230, 898-967; src/dsp/SoloMonitor.cpp:59-109
