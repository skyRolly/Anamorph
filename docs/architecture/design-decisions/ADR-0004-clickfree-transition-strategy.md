...
## Related code
- `src/dsp/AnamorphEngine.cpp:178-205` (`discreteDiffers`, exclusions), `:480-562` (switch machine)
...
Evidence [Verified]:
- Source: src/dsp/AnamorphEngine.cpp:178-205, 873-942; src/dsp/SoloMonitor.cpp:59-109
