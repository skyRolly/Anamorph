...
## Related code
- `src/dsp/AnamorphEngine.cpp:384-411` (`discreteDiffers`, exclusions), `:480-562` (switch machine)
...
Evidence [Verified]:
- Source: src/dsp/AnamorphEngine.cpp:384-411, 1368-1579; src/dsp/SoloMonitor.cpp:59-109
