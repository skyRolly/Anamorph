...
## Related code
- `src/dsp/AnamorphEngine.cpp:352-379` (`discreteDiffers`, exclusions), `:480-562` (switch machine)
...
Evidence [Verified]:
- Source: src/dsp/AnamorphEngine.cpp:352-379, 1251-1462; src/dsp/SoloMonitor.cpp:59-109
