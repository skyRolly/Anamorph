...
- `CMakeLists.txt:124-135` (INTERFACE lib), `:228-237` (tests link the core)

Evidence [Verified]:
- Source: src/dsp/AnamorphEngine.h:38-39; src/dsp/EngineParameters.h:3-17; CMakeLists.txt:124-135
