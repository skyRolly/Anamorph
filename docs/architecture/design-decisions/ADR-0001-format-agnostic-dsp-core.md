...
- `CMakeLists.txt:204-215` (INTERFACE lib), `:314-323` (tests link the core)

Evidence [Verified]:
- Source: src/dsp/AnamorphEngine.h:39-40; src/dsp/EngineParameters.h:3-17; CMakeLists.txt:204-215
