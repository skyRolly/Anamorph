...
- `CMakeLists.txt:244-255` (INTERFACE lib), `:370-379` (tests link the core)

Evidence [Verified]:
- Source: src/dsp/AnamorphEngine.h:39-40; src/dsp/EngineParameters.h:3-17; CMakeLists.txt:244-255
