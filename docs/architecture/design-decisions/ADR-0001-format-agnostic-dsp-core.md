...
- `CMakeLists.txt:200-211` (INTERFACE lib), `:314-323` (tests link the core)

Evidence [Verified]:
- Source: src/dsp/AnamorphEngine.h:39-40; src/dsp/EngineParameters.h:3-17; CMakeLists.txt:200-211
