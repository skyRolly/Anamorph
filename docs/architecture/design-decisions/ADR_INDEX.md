...
| [ADR-0026](ADR-0026-juce-9.0.1-upgrade.md) | JUCE dependency upgrade 9.0.0 → 9.0.1 (immutable-commit pin retained; no source or build-dependency change) | Proposed (pending Architecture-Review sign-off + Level-5 audition) | Verified headlessly (32-scenario twin-dump bit-identical incl. latencies; 140 + 894 suites green; registry snapshot unchanged; pluginval 10 both modes ×3) |
