...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:764, 924-927`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:698-834
