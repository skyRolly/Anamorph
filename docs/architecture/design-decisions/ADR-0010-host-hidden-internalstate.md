...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:328, 390-393`

Evidence [Verified]:
- Source: src/InternalState.h:10-138; src/PluginProcessor.cpp:321-393
