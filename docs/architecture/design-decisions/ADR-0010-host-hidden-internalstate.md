...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:801, 1016-1019`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:735-842
