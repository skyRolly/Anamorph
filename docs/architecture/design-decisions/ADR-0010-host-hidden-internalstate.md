...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:535,712-715`

Evidence [Verified]:
- Source: src/InternalState.h:13-296; src/PluginProcessor.cpp:479-670
