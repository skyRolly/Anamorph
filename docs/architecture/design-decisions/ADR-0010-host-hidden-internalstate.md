...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:943, 1279-1283`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:877-984
