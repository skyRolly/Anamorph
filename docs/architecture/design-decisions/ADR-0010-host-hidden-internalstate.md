...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:1113, 1461-1465`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:1047-1154
