...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:525,660-663`

Evidence [Verified]:
- Source: src/InternalState.h:13-296; src/PluginProcessor.cpp:479-618
