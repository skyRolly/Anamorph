...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:411,546-549`

Evidence [Verified]:
- Source: src/InternalState.h:10-138; src/PluginProcessor.cpp:365-504
