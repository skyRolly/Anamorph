...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:1038, 1374-1378`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:972-1079
