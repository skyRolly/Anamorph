...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:737, 870-873`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:671-778
