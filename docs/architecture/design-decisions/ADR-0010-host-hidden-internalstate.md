...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:1328, 1773-1777`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:1262-1369
