...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:750, 945-948`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:684-791
