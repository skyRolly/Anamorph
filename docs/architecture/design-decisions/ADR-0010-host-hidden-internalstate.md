...
## Related code
- `src/InternalState.h:13-539` (whole class), `:100-122` (migration)
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:1135, 1483-1487`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:1069-1176
