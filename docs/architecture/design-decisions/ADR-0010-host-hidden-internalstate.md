...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:849, 1100-1103`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:783-890
