...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:545, 722-725`

Evidence [Verified]:
- Source: src/InternalState.h:13-296; src/PluginProcessor.cpp:489-680
