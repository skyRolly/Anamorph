...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:453,588-591`

Evidence [Verified]:
- Source: src/InternalState.h:10-138; src/PluginProcessor.cpp:407-546
