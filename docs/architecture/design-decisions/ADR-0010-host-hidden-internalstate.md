...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:379,473-476`

Evidence [Verified]:
- Source: src/InternalState.h:10-138; src/PluginProcessor.cpp:333-431
