...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:739, 909-912`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:673-780
