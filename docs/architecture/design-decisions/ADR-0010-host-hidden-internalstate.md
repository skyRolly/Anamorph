...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:738, 889-892`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:672-779
