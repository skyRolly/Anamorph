...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:893, 1185-1188`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:827-934
