...
## Related code
- `src/InternalState.h:13-349` (whole class), `:100-122` (migration)
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:664, 799-802`

Evidence [Verified]:
- Source: src/InternalState.h:13-349; src/PluginProcessor.cpp:619-728
