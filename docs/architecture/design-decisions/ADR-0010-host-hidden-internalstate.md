...
## Related code
- `src/InternalState.h:13-380` (whole class), `:100-122` (migration)
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:680, 820-823`

Evidence [Verified]:
- Source: src/InternalState.h:13-380; src/PluginProcessor.cpp:635-744
