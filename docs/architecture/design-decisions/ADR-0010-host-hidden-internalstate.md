...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:872, 1132-1135`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:806-913
