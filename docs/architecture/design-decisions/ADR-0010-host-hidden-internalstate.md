...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:1327, 1772-1776`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:1261-1368
