...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:894, 1204-1207`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:828-935
