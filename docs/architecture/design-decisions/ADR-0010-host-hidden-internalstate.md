...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:745, 905-908`

Evidence [Verified]:
- Source: src/InternalState.h:13-524; src/PluginProcessor.cpp:679-815
