...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:318, 380-383`

Evidence [Verified]:
- Source: src/InternalState.h:10-138; src/PluginProcessor.cpp:311-383
