...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:820, 1068-1071`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:754-861
