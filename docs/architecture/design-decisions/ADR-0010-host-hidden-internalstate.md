...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:787, 1002-1005`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:721-828
