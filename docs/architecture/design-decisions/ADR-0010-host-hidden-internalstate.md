...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:388,483-486`

Evidence [Verified]:
- Source: src/InternalState.h:10-138; src/PluginProcessor.cpp:342-441
