...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:670, 806-809`

Evidence [Verified]:
- Source: src/InternalState.h:13-380; src/PluginProcessor.cpp:625-734
