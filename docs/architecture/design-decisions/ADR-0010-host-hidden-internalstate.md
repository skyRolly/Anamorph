...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:838, 1086-1089`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:772-879
