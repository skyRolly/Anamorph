...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:1124, 1472-1476`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:1058-1165
