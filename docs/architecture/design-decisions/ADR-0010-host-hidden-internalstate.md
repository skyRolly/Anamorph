...
- `src/PluginParameters.cpp:183-190` (rationale comment); `src/PluginProcessor.cpp:922, 1251-1254`

Evidence [Verified]:
- Source: src/InternalState.h:13-539; src/PluginProcessor.cpp:856-963
