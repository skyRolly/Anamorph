...
- `ANAMORPH_JUCE_TAG` → **`e18f7f506c0b96f2c738a0bcd7fe6467a5005ad8`** (the commit of upstream
  ...
  banner (`CMakeLists.txt:70-72, 81-89`). GitHub still serves shallow fetch-by-SHA, so
...
## Related code
- `CMakeLists.txt:67-72` (pin + banner comment), `:76-84` (FetchContent).

Evidence:
- Source [Verified]: CMakeLists.txt:70-72 (`ANAMORPH_JUCE_VERSION "9.0.1"`, SHA pin).
