...
Evidence [Verified]: backward-compat paths at src/PluginProcessor.cpp:1327-1330 (pre-0.8.4, `resolveLegacy`), :1287-1360 (pre-0.6.4 `readSlot`), :1388-1410 (v0.2 bare APVTS);
...
Source: src/PluginProcessor.cpp:1192-1200 (write), :1268-1277 (read), :1104-1105 (adoption).
...
src/PluginProcessor.cpp:1232-1302; State test 27.
...
src/PluginProcessor.cpp:1453-1488 (the else-branch), :607 (the unparsable-blob guard).
...
src/PluginProcessor.cpp:979-1001 (`writeSelection`/`readSelection`), :585 (root write),
...
Source: src/PluginProcessor.cpp:1426-1450 (the `AB`-absent branch of `decodeRestore`), :1388-1410 (the
...
a later save wrote that duplicate out. Source: src/PluginProcessor.cpp:1351-1424
...
Evidence [Verified]: src/PluginProcessor.cpp:1398-1399 (the legacy-key fallback inside `readSlot`, :991-1078);
...
Source: src/PluginProcessor.cpp:1452-1476.
