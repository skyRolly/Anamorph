...
Evidence [Verified]: backward-compat paths at src/PluginProcessor.cpp:1312-1315 (pre-0.8.4, `resolveLegacy`), :1287-1360 (pre-0.6.4 `readSlot`), :1388-1410 (v0.2 bare APVTS);
...
Source: src/PluginProcessor.cpp:1177-1185 (write), :1268-1277 (read), :1104-1105 (adoption).
...
src/PluginProcessor.cpp:1217-1287; State test 27.
...
src/PluginProcessor.cpp:1438-1473 (the else-branch), :607 (the unparsable-blob guard).
...
src/PluginProcessor.cpp:972-994 (`writeSelection`/`readSelection`), :585 (root write),
...
Source: src/PluginProcessor.cpp:1411-1435 (the `AB`-absent branch of `decodeRestore`), :1388-1410 (the
...
a later save wrote that duplicate out. Source: src/PluginProcessor.cpp:1336-1409
...
Evidence [Verified]: src/PluginProcessor.cpp:1383-1384 (the legacy-key fallback inside `readSlot`, :991-1078);
...
Source: src/PluginProcessor.cpp:1437-1461.
