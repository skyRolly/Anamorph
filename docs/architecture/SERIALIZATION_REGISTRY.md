...
Evidence [Verified]: backward-compat paths at src/PluginProcessor.cpp:1280-1283 (pre-0.8.4, `resolveLegacy`), :1287-1360 (pre-0.6.4 `readSlot`), :1388-1410 (v0.2 bare APVTS);
...
Source: src/PluginProcessor.cpp:1151-1159 (write), :1268-1277 (read), :1104-1105 (adoption).
...
src/PluginProcessor.cpp:1191-1257; State test 27.
...
src/PluginProcessor.cpp:1406-1439 (the else-branch), :607 (the unparsable-blob guard).
...
Source: src/PluginProcessor.cpp:1379-1403 (the `AB`-absent branch of `decodeRestore`), :1388-1410 (the
...
a later save wrote that duplicate out. Source: src/PluginProcessor.cpp:1304-1377
...
Evidence [Verified]: src/PluginProcessor.cpp:1351-1352 (the legacy-key fallback inside `readSlot`, :991-1078);
...
Source: src/PluginProcessor.cpp:1405-1427.
