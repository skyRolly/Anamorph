...
Evidence [Verified]: src/dsp/AnamorphEngine.cpp:71-85 (`latency2` — the three oversamplers built
...
Evidence [Verified]: src/dsp/AnamorphEngine.cpp:83-85 (`latency2` / `latency4` / `latency8`, the
...
Evidence [Verified]: src/PluginProcessor.cpp:256-280 (`deliverLatency` + `updateLatency`), :110-115 (`parameterChanged`); src/dsp/AnamorphEngine.cpp:415-420,
:293-329, :494-509.
