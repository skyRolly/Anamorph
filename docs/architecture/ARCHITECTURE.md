...
- Source: src/PluginProcessor.cpp:186-191 (per-block snapshot → `engine.setParameters` → `engine.process`)
...
- Source: src/PluginProcessor.cpp:136 (`juce::ScopedNoDenormals`)
