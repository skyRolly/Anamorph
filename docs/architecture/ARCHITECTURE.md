...
- Source: src/PluginProcessor.cpp:378-383 (per-block snapshot → `engine.setParameters` → `engine.process`)
...
- Source: src/PluginProcessor.cpp:328 (`juce::ScopedNoDenormals`)
