...
Evidence [Verified]:
- Source: src/PluginProcessor.cpp:137-205 (`processBlock`), :119 `ScopedNoDenormals`
...
- Source: src/PluginEditor.cpp:1842-1843 (`triggerRepaint` guarded by `isAttached()`)
...
| Editor `juce::Timer` | 24 Hz | view-state sync, preset display, `pollUndoCoalesce()`, undo/redo enable, match-gain readout | src/PluginEditor.cpp:683, 1381-1538 |
...
(the VBlank lambda captures `this`). Source: src/PluginEditor.cpp:700-702.
