...
- Source: src/PluginEditor.cpp:701 (24 Hz timer), :686-692 (VBlank), :306-320 (OpenGL gate)
...
(the VBlank lambda captures `this`). Source: src/PluginEditor.cpp:718-720.
...
| UI-animation flag → imager | `const std::atomic<float>*` (relaxed) | InternalState | GUI imager timer | src/InternalState.h:72; src/gui/SpectrumImager.cpp:1638 |
