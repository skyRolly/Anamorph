...
| QA gate | 33 DSP self-tests + A/B guard (140 checks) + the 12-test state-compatibility suite (842 checks) + pluginval strictness 10, deterministic + randomise ×3, blocking on 3 OSes; Level-5 manual audition | [Verified] TESTING_POLICY.md, CI_CD.md |
