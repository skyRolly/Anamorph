...
| QA gate | 47 DSP self-tests + A/B guard (245 checks) + the 24-test state-compatibility suite (1057 checks) + pluginval strictness 10, deterministic + randomise ×3, blocking on 3 OSes; Level-5 manual audition | [Verified] TESTING_POLICY.md, CI_CD.md |
