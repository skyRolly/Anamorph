...
| QA gate | 45 DSP self-tests + A/B guard (241 checks) + the 16-test state-compatibility suite (928 checks) + pluginval strictness 10, deterministic + randomise ×3, blocking on 3 OSes; Level-5 manual audition | [Verified] TESTING_POLICY.md, CI_CD.md |
