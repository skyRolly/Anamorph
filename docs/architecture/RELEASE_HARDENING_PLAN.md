...
| QA gate | 37 DSP self-tests + A/B guard (162 checks) + the 13-test state-compatibility suite (911 checks) + pluginval strictness 10, deterministic + randomise ×3, blocking on 3 OSes; Level-5 manual audition | [Verified] TESTING_POLICY.md, CI_CD.md |
