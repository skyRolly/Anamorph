...
| QA gate | 45 DSP self-tests + A/B guard (241 checks) + the 18-test state-compatibility suite (941 checks) + pluginval strictness 10, deterministic + randomise ×3, blocking on 3 OSes; Level-5 manual audition | [Verified] TESTING_POLICY.md, CI_CD.md |
