...
| mono → stereo | **Verified** | src/PluginProcessor.cpp:174-175 (mono input accepted), :120-121 (mono duplicated to both channels) |
| **mono → mono** | **Not Supported** | Deliberately rejected: output is always stereo. src/PluginProcessor.cpp:171-172 |
