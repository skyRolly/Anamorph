...
Evidence [Verified]: src/PluginProcessor.cpp:2076-2162 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:2076-2162 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:661-717 (`applyStatePreservingView`).
