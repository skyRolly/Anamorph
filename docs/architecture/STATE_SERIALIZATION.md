...
Evidence [Verified]: src/PluginProcessor.cpp:2629-2715 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:2629-2715 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:1032-1107 (`applyStatePreservingView`).
