...
Evidence [Verified]: src/PluginProcessor.cpp:2104-2190 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:2104-2190 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:682-738 (`applyStatePreservingView`).
