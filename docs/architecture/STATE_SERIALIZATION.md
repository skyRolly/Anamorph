...
Evidence [Verified]: src/PluginProcessor.cpp:1777-1863 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1777-1863 (`getStateInformation`).
