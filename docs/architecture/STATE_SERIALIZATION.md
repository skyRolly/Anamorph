...
Evidence [Verified]: src/PluginProcessor.cpp:1433-1519 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1433-1519 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:478-534 (`applyStatePreservingView`).
