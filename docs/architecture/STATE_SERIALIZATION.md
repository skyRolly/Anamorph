...
Evidence [Verified]: src/PluginProcessor.cpp:1313-1399 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1313-1399 (`getStateInformation`).
