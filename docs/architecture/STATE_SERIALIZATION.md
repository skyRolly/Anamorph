...
Evidence [Verified]: src/PluginProcessor.cpp:1899-1985 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1899-1985 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:612-668 (`applyStatePreservingView`).
