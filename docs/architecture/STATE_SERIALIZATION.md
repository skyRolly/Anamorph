...
Evidence [Verified]: src/PluginProcessor.cpp:2353-2439 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:2353-2439 (`getStateInformation`).
...
| **pre-0.9.2**: no indicator identity in the session | `decodeSelection` yields `unknown` → name fallback | src/PresetManager.cpp:774-791; :128-131 |
...
Evidence [Verified]: src/PluginProcessor.cpp:874-930 (`applyStatePreservingView`).
