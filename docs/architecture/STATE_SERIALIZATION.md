...
Evidence [Verified]: src/PluginProcessor.cpp:1457-1543 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1457-1543 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:479-535 (`applyStatePreservingView`).
