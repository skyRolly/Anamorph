...
Evidence [Verified]: src/PluginProcessor.cpp:1835-1921 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1835-1921 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:560-616 (`applyStatePreservingView`).
