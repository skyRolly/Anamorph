...
Evidence [Verified]: src/PluginProcessor.cpp:2029-2115 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:2029-2115 (`getStateInformation`).
