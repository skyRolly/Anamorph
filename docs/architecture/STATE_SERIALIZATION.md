...
Evidence [Verified]: src/PluginProcessor.cpp:2563-2649 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:2563-2649 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:966-1041 (`applyStatePreservingView`).
