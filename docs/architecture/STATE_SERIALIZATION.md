...
Evidence [Verified]: src/PluginProcessor.cpp:1603-1689 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1603-1689 (`getStateInformation`).
