...
Evidence [Verified]: src/PluginProcessor.cpp:1853-1939 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1853-1939 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:578-634 (`applyStatePreservingView`).
