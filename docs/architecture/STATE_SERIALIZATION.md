...
Evidence [Verified]: src/PluginProcessor.cpp:1981-2067 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1981-2067 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:633-689 (`applyStatePreservingView`).
