...
Evidence [Verified]: src/PluginProcessor.cpp:1783-1869 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1783-1869 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:541-597 (`applyStatePreservingView`).
