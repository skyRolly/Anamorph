...
Evidence [Verified]: src/PluginProcessor.cpp:2633-2719 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:2633-2719 (`getStateInformation`).
...
| **pre-0.9.2**: no indicator identity in the session | `decodeSelection` yields `unknown` → name fallback | src/PresetManager.cpp:913-930; :128-131 |
...
Evidence [Verified]: src/PluginProcessor.cpp:1036-1111 (`applyStatePreservingView`).
