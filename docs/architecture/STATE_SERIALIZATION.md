...
Evidence [Verified]: src/PluginProcessor.cpp:1235-1284 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1235-1284 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:442-467 (`applyStatePreservingView`).
