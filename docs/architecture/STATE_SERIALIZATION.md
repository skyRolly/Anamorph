...
Evidence [Verified]: src/PluginProcessor.cpp:1306-1355 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1306-1355 (`getStateInformation`).
...
| **pre-0.9.2**: no indicator identity in the session | `decodeSelection` yields `unknown` → name fallback | src/PresetManager.cpp:712-729; :128-131 |
...
Evidence [Verified]: src/PluginProcessor.cpp:455-480 (`applyStatePreservingView`).
