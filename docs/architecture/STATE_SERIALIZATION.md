...
Evidence [Verified]: src/PluginProcessor.cpp:1536-1622 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1536-1622 (`getStateInformation`).
