...
Evidence [Verified]: src/PluginProcessor.cpp:1581-1667 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1581-1667 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:490-546 (`applyStatePreservingView`).
