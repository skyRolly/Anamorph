...
Evidence [Verified]: src/PluginProcessor.cpp:2559-2645 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:2559-2645 (`getStateInformation`).
