...
Evidence [Verified]: src/PluginProcessor.cpp:1763-1849 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1763-1849 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:527-583 (`applyStatePreservingView`).
