...
Evidence [Verified]: src/PluginProcessor.cpp:2627-2713 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:2627-2713 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:1030-1105 (`applyStatePreservingView`).
