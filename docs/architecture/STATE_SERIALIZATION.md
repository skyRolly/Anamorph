...
Evidence [Verified]: src/PluginProcessor.cpp:1362-1448 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1362-1448 (`getStateInformation`).
...
| **pre-0.9.2**: no indicator identity in the session | `decodeSelection` yields `unknown` → name fallback | src/PresetManager.cpp:718-735; :128-131 |
...
Evidence [Verified]: src/PluginProcessor.cpp:459-484 (`applyStatePreservingView`).
