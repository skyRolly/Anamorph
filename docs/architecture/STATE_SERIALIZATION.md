...
Evidence [Verified]: src/PluginProcessor.cpp:1234-1283 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1234-1283 (`getStateInformation`).
