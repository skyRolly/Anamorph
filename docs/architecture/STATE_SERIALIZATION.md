...
Evidence [Verified]: src/PluginProcessor.cpp:1867-1953 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1867-1953 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:589-645 (`applyStatePreservingView`).
