...
Evidence [Verified]: src/PluginProcessor.cpp:2342-2428 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:2342-2428 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:863-919 (`applyStatePreservingView`).
