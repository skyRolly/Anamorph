...
Evidence [Verified]: src/PluginProcessor.cpp:1219-1268 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1219-1268 (`getStateInformation`).
