...
Evidence [Verified]: src/PluginProcessor.cpp:2742-2828 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:2742-2828 (`getStateInformation`).
...
| **pre-0.9.2**: no indicator identity in the session | `decodeSelection` yields `unknown` → name fallback | src/PresetManager.cpp:1293-1310; :128-131 |
...
Evidence [Verified]: src/PluginProcessor.cpp:1048-1123 (`applyStatePreservingView`).
