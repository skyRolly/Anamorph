...
Evidence [Verified]: src/PluginProcessor.cpp:1313-1396 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1313-1396 (`getStateInformation`).
