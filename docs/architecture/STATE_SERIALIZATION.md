...
Evidence [Verified]: src/PluginProcessor.cpp:1248-1297 (`getStateInformation`), :1226-1485
...
Evidence [Verified]: src/PluginProcessor.cpp:1248-1297 (`getStateInformation`).
