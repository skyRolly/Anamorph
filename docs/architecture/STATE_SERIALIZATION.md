...
Evidence [Verified]: src/PluginProcessor.cpp:618-648 (`getStateInformation`), :605-744
...
Evidence [Verified]: src/PluginProcessor.cpp:618-648 (`getStateInformation`).
...
Evidence [Verified]: src/PluginProcessor.cpp:273-288 (`applyStatePreservingView`).
