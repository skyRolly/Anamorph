...
`SpectrumImager::projectFromOrig` (src/gui/SpectrumImager.cpp:464) validated its pin arguments
...
anchored it, src/gui/SpectrumImager.cpp:777 today: `dropX`
...
in that cell are now written in full (`src/InternalState.h:72; src/gui/SpectrumImager.cpp:939`), and
...
Both consumers re-read a **live** `bandCount()`: `dragCrossoverTo` (src/gui/SpectrumImager.cpp:499)
...
"line 512 as PREfast anchored it, src/gui/SpectrumImager.cpp:777 today", which keeps the fact and
