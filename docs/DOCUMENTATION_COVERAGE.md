...
Last updated: for **performance Wave 4 — idle/background runtime optimisation** (2026-07-19,
...
PERFORMANCE_BUDGET (GUI row + two new Wave-4 cost bullets), CHANGELOG (`[Unreleased]`),
