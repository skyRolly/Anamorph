...
`SpectrumImager::projectFromOrig` (src/gui/SpectrumImager.cpp:458) validated its pin arguments
...
anchored it, src/gui/SpectrumImager.cpp:765 today: `dropX`
...
in that cell are now written in full (`src/InternalState.h:72; src/gui/SpectrumImager.cpp:927`), and
...
Both consumers re-read a **live** `bandCount()`: `dragCrossoverTo` (src/gui/SpectrumImager.cpp:493)
...
"line 512 as PREfast anchored it, src/gui/SpectrumImager.cpp:765 today", which keeps the fact and
