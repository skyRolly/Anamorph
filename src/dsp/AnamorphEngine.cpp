...
void AnamorphEngine::process (juce::AudioBuffer<float>& buffer) noexcept
{
    ...
    // -------- 2a. Oversampled nonlinear / modulation region -----------------
    ...
    // -------- 5b. Output Gain / Auto Gain / Output Balance ------------------
    for (int i = 0; i < n; ++i)
    {
